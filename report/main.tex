...
In a context where cyber threats are becoming increasingly sophisticated, establishing a surveillance and security incident detection infrastructure has become essential for any organization. This project is part of the \textbf{Cloud Computing} module and aims to demonstrate the implementation of a SIEM (Security Information and Event Management) and EDR (Endpoint Detection and Response) solution in a cloud environment.

The \textbf{Wazuh} platform, a recognized open-source solution in the cybersecurity field, was chosen for its versatility, scalability, and ability to unify SIEM and EDR functionalities within a single platform.
...
\begin{enumerate}
    \item \textbf{Design and deploy} a secure cloud architecture on AWS with network segmentation
    \item \textbf{Install and configure} a Wazuh Manager server for centralized log collection
    \item \textbf{Deploy agents} on Linux (Ubuntu) and Windows Server systems
    \item \textbf{Generate and analyze} real-time security alerts
    \item \textbf{Understand the differences} between SIEM and EDR approaches
    \item \textbf{Apply proactive} Threat Hunting techniques
    \item \textbf{Master IAM/PAM concepts} in an operational security context
\end{enumerate}
...
\hline
\multirow{3}{*}{Cloud} & AWS EC2 & Virtual machine hosting \\
& AWS VPC & Network isolation and segmentation \\
& Security Groups & Network access control (firewall) \\
\hline
\multirow{3}{*}{SIEM/EDR} & Wazuh Manager & Central collection and analysis server \\
& Wazuh Dashboard & Visualization and reporting interface \\
& Wazuh Agents & Event collection on endpoints \\
\hline
\multirow{2}{*}{Endpoints} & Ubuntu 22.04 LTS & Linux client for monitoring \\
& Windows Server 2022 & Windows client with Sysmon \\
\hline
Monitoring & Sysmon & Advanced Windows process telemetry \\
\hline
\end{tabularx}
\caption{Lab Technology Stack}
\end{table}

\subsection{Lab Scope}

This laboratory covers the following aspects:

\begin{itemize}
    \item \textbf{Infrastructure:} Deployment of an AWS VPC with public subnets, EC2 instances, and security groups
    \item \textbf{Log Collection:} Configuration of Wazuh agents for system event forwarding
    \item \textbf{Attack Detection:} Simulation and analysis of SSH brute force attacks, privilege escalation
    \item \textbf{Windows Monitoring:} Sysmon integration for in-depth process visibility
    \item \textbf{Threat Hunting:} Creation of proactive threat search queries
\end{itemize}

\begin{infobox}[Source Code]
The source code and complete documentation for this project are available on GitHub:

\centering
\textbf{\large \href{https://github.com/yassernamez03/wazuh-siem-edr-cloud-lab}{\textcolor{wazuhblue}{https://github.com/yassernamez03/wazuh-siem-edr-cloud-lab}}}
\end{infobox}
...
\subsection{Skills Acquired Summary}

This practical laboratory enabled the acquisition and validation of essential skills in operational cybersecurity:

\begin{itemize}
    \item \textbf{Secure Cloud Architecture:} Design and deployment of AWS infrastructure with VPC, subnets, and security groups following the principle of least privilege
    \item \textbf{SIEM Administration:} Installation, configuration, and management of a Wazuh Manager server with its dashboard
    \item \textbf{Agent Deployment:} Enrollment and configuration of monitoring agents on heterogeneous systems (Linux/Windows)
    \item \textbf{Security Analysis:} Interpretation of alerts and correlation of security events
    \item \textbf{Threat Hunting:} Creation of proactive search queries for anomaly detection
    \item \textbf{EDR with Sysmon:} Configuration of advanced telemetry for Windows process monitoring
\end{itemize}

\subsection{Importance of SIEM/EDR in a Modern SOC}
...
\begin{tabularx}{\textwidth}{|l|X|}
\hline
\textbf{Function} & \textbf{Value for SOC} \\
\hline
...
\hline
\end{tabularx}
\caption{SIEM/EDR Value for SOC}
\end{table}
...
\begin{enumerate}
    \item \textbf{SOAR Integration:} Incident response automation with playbooks
    \item \textbf{Threat Intelligence Feeds:} Connection to external sources (MISP, VirusTotal)
    \item \textbf{Machine Learning:} Anomaly detection based on machine learning
    \item \textbf{Red Team Exercises:} Simulation of advanced attacks (APT, ransomware)
    \item \textbf{Cloud SIEM:} Extension to other cloud providers (Azure, GCP)
    \item \textbf{Kubernetes Monitoring:} Containerized environment surveillance
\end{enumerate}
...
\begin{itemize}
    \item \textbf{Prof. Azeddine KHIAT} for his guidance and valuable advice throughout this Cloud Computing module
    \item \textbf{The Wazuh Team} for providing a professional-grade open-source solution
    \item \textbf{The Cybersecurity Community} for shared resources and documentation
\end{itemize}
...
\begin{center}
\textbf{\large Project Source Code}

\href{https://github.com/yassernamez03/wazuh-siem-edr-cloud-lab}{\textcolor{wazuhblue}{\texttt{https://github.com/yassernamez03/wazuh-siem-edr-cloud-lab}}}
\end{center}
...
\begin{enumerate}[label={[\arabic*]}]
    \item \textbf{Wazuh Documentation} - Official Wazuh Platform Documentation\\
    \url{https://documentation.wazuh.com}
    
    \item \textbf{AWS EC2 Documentation} - Complete Guide to Amazon EC2 Services\\
    \url{https://docs.aws.amazon.com/ec2}
    
    \item \textbf{Sysmon Documentation} - Microsoft Sysinternals System Monitor\\
    ...
    \item \textbf{AWS VPC Documentation} - Virtual Private Cloud Configuration\\
    \url{https://docs.aws.amazon.com/vpc}
    
    \item \textbf{NIST Cybersecurity Framework} - Cybersecurity Reference Framework\\
    \url{https://www.nist.gov/cyberframework}
    
    \item \textbf{CIS Benchmarks} - System Hardening Guidelines\\
